(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_b5b4ecee._.js", {
...
function QuickGoalsPage() {
    ...
    const [journalEntryText, setJournalEntryText] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(''); // For Additional Characteristics
            ...
            const dataForChart = dateInterval.map({
                "QuickGoalsPage.useEffect.dataForChart": (date)=>{
                    ...
                    const entryForDay = journalHistory.find({
                        "QuickGoalsPage.useEffect.dataForChart.entryForDay": (entry)=>entry.date.startsWith(isoDateString)
                    }["QuickGoalsPage.useEffect.dataForChart.entryForDay"]);
                    return {
    ...
    const handleJournalSubmit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "QuickGoalsPage.useCallback[handleJournalSubmit]": async ()=>{
            if (!goalText.trim() && !journalEntryText.trim() && !goalAchievementExperienceText.trim() && !bestCaseScenarioText.trim() && inBetweenOutcomes.every({
            ...
            try {
                ...
                const newEntry = {
                    ...
                    entryText: journalEntryText.trim() ? journalEntryText.trim() : undefined,
                    ...
                    ...inBetweenOutcomes.reduce({
                        "QuickGoalsPage.useCallback[handleJournalSubmit]": (acc, outcome, index)=>{
                            if (index < 10) {
                                acc[`inBetweenOutcome${index + 1}`] = outcome.trim() ? outcome.trim() : undefined;
                            }
                            return acc;
                        }
                    }["QuickGoalsPage.useCallback[handleJournalSubmit]"], {})
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                ...
                disabled: isLoadingAi || !goalText.trim() && !journalEntryText.trim() && !goalAchievementExperienceText.trim() && !bestCaseScenarioText.trim() && inBetweenOutcomes.every((o)=>!o.trim()),
...
_s(QuickGoalsPage, "+xI0ZYgrtzdYa3mcOWFJigu6Yks=", false, function() {
    return [
...
//# sourceMappingURL=src_b5b4ecee._.js.map