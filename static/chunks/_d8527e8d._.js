(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_d8527e8d._.js", {
...
function ProcessingPage() {
    ...
    const [isLoadingAi, setIsLoadingAi] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // Used for AI calls and main submit
            ...
            try {
                ...
                if (storedHistory) {
                    ...
                    const processingEntries = parsedHistory.filter({
                        "ProcessingPage.useEffect.processingEntries": (entry)=>entry.isFailProof === true || entry.failureReason && entry.failureReason.trim() !== ''
                ...
                setJournalHistory({
                    "ProcessingPage.useCallback[handleJournalSubmit]": (prevHistory)=>{
                        ...
                        const previousProcessingEntries = prevHistory.filter({
                            "ProcessingPage.useCallback[handleJournalSubmit].previousProcessingEntries": (entry)=>entry.isFailProof === true || entry.failureReason && entry.failureReason.trim() !== ''
                        }["ProcessingPage.useCallback[handleJournalSubmit].previousProcessingEntries"]);
...
_s(ProcessingPage, "yBJgmnic3MWwWltUvKY+YUB17HI=", false, function() {
    return [
...
//# sourceMappingURL=_d8527e8d._.js.map