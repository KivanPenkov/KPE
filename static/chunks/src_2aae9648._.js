(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_2aae9648._.js", {
...
function ReflectifyPage() {
            ...
            try {
                ...
                if (focusedId && focusedType && localJournalHistory.length > 0) {
                    const entry = localJournalHistory.find({
                        "ReflectifyPage.useEffect.entry": (e)=>e.id === focusedId
                    }["ReflectifyPage.useEffect.entry"]);
                    if (entry) {
                        let textToShow = '';
                        let typeString = '';
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReflectifyPage.useEffect": ()=>{
            ...
            const dataForChart = dateInterval.map({
                "ReflectifyPage.useEffect.dataForChart": (date)=>{
                    const isoDateString = date.toISOString().split('T')[0];
                    const entryForDay = journalHistory.find({
                        "ReflectifyPage.useEffect.dataForChart.entryForDay": (entry)=>entry.date.startsWith(isoDateString)
                    }["ReflectifyPage.useEffect.dataForChart.entryForDay"]);
                    return {
            ...
            }["ReflectifyPage.useEffect.dataForChart"]);
    ...
    const handleJournalSubmit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ReflectifyPage.useCallback[handleJournalSubmit]": async ()=>{
            if (!journalEntryText.trim() && negativeCharacteristics.every({
                "ReflectifyPage.useCallback[handleJournalSubmit]": (char)=>!char.name.trim()
            }["ReflectifyPage.useCallback[handleJournalSubmit]"]) && !goalText.trim()) {
                toast({
                    title: 'Empty Entry',
            ...
            try {
                ...
                const newEntry = {
                    ...
                    negativeCharacteristics: negativeCharacteristics.filter({
                        "ReflectifyPage.useCallback[handleJournalSubmit]": (char)=>char.name.trim()
                    }["ReflectifyPage.useCallback[handleJournalSubmit]"]).map({
                        "ReflectifyPage.useCallback[handleJournalSubmit]": ({ id, ...rest })=>rest
                    }["ReflectifyPage.useCallback[handleJournalSubmit]"])
                };
                setJournalHistory({
                    "ReflectifyPage.useCallback[handleJournalSubmit]": (prevHistory)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Setting your goal: make sure your goal is achievable (on a scale from 0-10), a deadline."
                            }, void 0, false, {
                                fileName: "[project]/src/app/page.tsx",
                                lineNumber: 238,
                                columnNumber: 12
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                disabled: isLoadingAi || !journalEntryText.trim() && negativeCharacteristics.every((char)=>!char.name.trim()) && !goalText.trim(),
                                className: "w-full sm:w-auto bg-accent text-accent-foreground hover:bg-accent/90 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-2 px-6 py-3 text-base rounded-lg shadow-md transition-all duration-150 ease-in-out hover:shadow-lg",
            ...
            currentSentiment && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                className: "shadow-lg rounded-xl overflow-hidden",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
...
_s(ReflectifyPage, "drkvZaptsijkj3HFfAy6kVRJdoY=", false, function() {
    return [
...
_c = ReflectifyPage;
var _c;
__turbopack_context__.k.register(_c, "ReflectifyPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_2aae9648._.js.map