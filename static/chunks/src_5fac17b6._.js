(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_5fac17b6._.js", {
...
function ProcessingPage() {
    ...
    const handleSetCanGoalFail = (value)=>{
        ...
        if (value === false) {
            ...
            // Reset insights when switching to "Yes, failure is possible" but keep failureReason
            setInsightsText('');
            setShowProcessingResults(false); // Hide results until processed again
        }
    };
        ...
        "ProcessingPage.useCallback[handleFailureProcessing]": ()=>{
            ...
            setTimeout({
                "ProcessingPage.useCallback[handleFailureProcessing]": ()=>{
                    ...
                    setInsightsText(''); // Clear previous insights when re-processing
...
_s(ProcessingPage, "SUKI7TRQcloC9dq1N10RnUXQK8k=", false, function() {
    return [
...
//# sourceMappingURL=src_5fac17b6._.js.map